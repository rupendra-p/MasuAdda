    ...
    <div>
      <nav className="navbar fixed-top navbar-expand-lg navbar-light bg-danger">
        <div className="container-fluid">
          <Link className="navbar-brand" to="/">MasuAdda</Link>
          ...
          <Link className="navbar-brand" to="/cart"><i className="fa fa-shopping-cart fa-1x my-1" style={{fontSize: "1.5em", color: cartItems.length > 0 ? "black" : "unset" }}aria-hidden="true"></i></Link>
